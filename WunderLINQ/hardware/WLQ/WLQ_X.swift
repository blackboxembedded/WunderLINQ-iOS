...
class WLQ_X: WLQ {
    ...
    let hardwareVersion1:String = "WLQX1.0"
    ...
    let RTKPagePressKey_INDEX:Int = 3
    let RTKPageDoublePressKeyType_INDEX:Int = 4
    let RTKPageDoublePressKeyModifier_INDEX:Int = 5
    let RTKPageDoublePressKey_INDEX:Int = 6
    let RTKZoomPPressKeyType_INDEX:Int = 7
    let RTKZoomPPressKeyModifier_INDEX:Int = 8
    let RTKZoomPPressKey_INDEX:Int = 9
    let RTKZoomPDoublePressKeyType_INDEX:Int = 10
    let RTKZoomPDoublePressKeyModifier_INDEX:Int = 11
    let RTKZoomPDoublePressKey_INDEX:Int = 12
    let RTKZoomMPressKeyType_INDEX:Int = 13
    let RTKZoomMPressKeyModifier_INDEX:Int = 14
    let RTKZoomMPressKey_INDEX:Int = 15
    let RTKZoomMDoublePressKeyType_INDEX:Int = 16
    let RTKZoomMDoublePressKeyModifier_INDEX:Int = 17
    let RTKZoomMDoublePressKey_INDEX:Int = 18
    let RTKSpeakPressKeyType_INDEX:Int = 19
    let RTKSpeakPressKeyModifier_INDEX:Int = 20
    let RTKSpeakPressKey_INDEX:Int = 21
    let RTKSpeakDoublePressKeyType_INDEX:Int = 22
    let RTKSpeakDoublePressKeyModifier_INDEX:Int = 23
    let RTKSpeakDoublePressKey_INDEX:Int = 24
    let RTKMutePressKeyType_INDEX:Int = 25
    let RTKMutePressKeyModifier_INDEX:Int = 26
    let RTKMutePressKey_INDEX:Int = 27
    let RTKMuteDoublePressKeyType_INDEX:Int = 28
    let RTKMuteDoublePressKeyModifier_INDEX:Int = 29
    let RTKMuteDoublePressKey_INDEX:Int = 30
    let RTKDisplayPressKeyType_INDEX:Int = 31
    let RTKDisplayPressKeyModifier_INDEX:Int = 32
    let RTKDisplayPressKey_INDEX:Int = 33
    let RTKDisplayDoublePressKeyType_INDEX:Int = 34
    let RTKDisplayDoublePressKeyModifier_INDEX:Int = 35
    let RTKDisplayDoublePressKey_INDEX:Int = 36
    let fullSensitivity_INDEX:Int = 37
    let fullRightPressKeyType_INDEX:Int = 38
    let fullRightPressKeyModifier_INDEX:Int = 39
    let fullRightPressKey_INDEX:Int = 40
    let fullRightLongPressKeyType_INDEX:Int = 41
    let fullRightLongPressKeyModifier_INDEX:Int = 42
    let fullRightLongPressKey_INDEX:Int = 43
    let fullLeftPressKeyType_INDEX:Int = 44
    let fullLeftPressKeyModifier_INDEX:Int = 45
    let fullLeftPressKey_INDEX:Int = 46
    let fullLeftLongPressKeyType_INDEX:Int = 47
    let fullLeftLongPressKeyModifier_INDEX:Int = 48
    let fullLeftLongPressKey_INDEX:Int = 49
    let fullScrollUpKeyType_INDEX:Int = 50
    let fullScrollUpKeyModifier_INDEX:Int = 51
    let fullScrollUpKey_INDEX:Int = 52
    let fullScrollDownKeyType_INDEX:Int = 53
    let fullScrollDownKeyModifier_INDEX:Int = 54
    let fullScrollDownKey_INDEX:Int = 55
    let fullSignalPressKeyType_INDEX:Int = 56
    let fullSignalPressKeyModifier_INDEX:Int = 57
    let fullSignalPressKey_INDEX:Int = 58
    ...
    override func parseConfig(bytes: [UInt8]) {
        ...
        print("WLQ_X: flashConfig: \(messageHexString)")
    ...
    override func setActionValue(action: Int?, value: UInt8){
        ...
        case pdmChannel4:
            tempConfig![pdmChannel2_INDEX] = value;
        default:
            print("WLQ_X: setActionValue Unknown Action ID:")
        }
    }
    ...
    override func setfirmwareVersion(firmwareVersion: String?){
        print("WLQ_X: Firmware Version: \(firmwareVersion ?? "?")")
    ...
    override func sethardwareVersion(hardwareVersion: String?){
        print("WLQ_X: HW Version: \(hardwareVersion ?? "?")")
